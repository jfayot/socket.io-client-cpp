...
namespace sio
{
  ...
  public:
    ...
    virtual json to_json(std::vector<std::shared_ptr<const std::string>> &buffers) const
    {
      return json();
    }

    static message::ptr from_json(const json &j);

    static message::ptr from_json(const json &j, const std::vector<std::shared_ptr<const std::string>> &buffers);
  ...
  public:
    ...
    json to_json(std::vector<std::shared_ptr<const std::string>> &buffers) const override
    {
      return nullptr;
    }
  };
  ...
  public:
    ...
    json to_json() const override
    {
      return json::binary_t(std::vector<uint8_t>{_v->begin(), _v->end()});
    }
  ...
  public:
    ...
    {
      json result;
      for (const auto &elt : _v)
      {
        result.push_back(elt->to_json());
      }
      return result;
    }
    ...
    json to_json(std::vector<std::shared_ptr<const std::string>> &buffers) const override
    {
      ...
      for (const auto &elt : _v)
      {
        result.push_back(elt->to_json(buffers));
      }
      return result;
    }
  ...
  public:
    ...
    json to_json(std::vector<std::shared_ptr<const std::string>> &buffers) const override
    {
      ...
      for (const auto &[key, val] : _v)
      {
        result[key] = val->to_json(buffers);
      }
      return result;
    }
